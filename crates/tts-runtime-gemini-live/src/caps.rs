...
pub const GEMINI_LIVE_VOICES: &[VoiceDescriptor] = &[
    VoiceDescriptor { id: "Puck",   name: "Puck",   language: "en-us", gender: Gender::Male },
    VoiceDescriptor { id: "Charon", name: "Charon", language: "en-us", gender: Gender::Male },
    VoiceDescriptor { id: "Kore",   name: "Kore",   language: "en-us", gender: Gender::Female },
    VoiceDescriptor { id: "Fenrir", name: "Fenrir", language: "en-us", gender: Gender::Male },
    VoiceDescriptor { id: "Aoede",  name: "Aoede",  language: "en-us", gender: Gender::Female },
];
...
pub const CAPS: Capabilities = Capabilities {
    ...
    voice_library: VoiceCatalog::Static { voices: GEMINI_LIVE_VOICES },
